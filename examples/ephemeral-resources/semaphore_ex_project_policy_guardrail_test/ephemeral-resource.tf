ephemeral "semaphore_ex_project_policy_guardrail_test" "example" {
  project_id  = 1
...
# Reference ephemeral.semaphore_ex_project_policy_guardrail_test.example.result in an ephemeral context.
