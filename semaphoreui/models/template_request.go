...
var templateRequestTypeTypePropEnum []any
...
// ContextValidate validate this template request based on the context it is used
...
func (m *TemplateRequest) contextValidateSurveyVars(ctx context.Context, formats strfmt.Registry) error {
...
func (m *TemplateRequest) contextValidateVaults(ctx context.Context, formats strfmt.Registry) error {
